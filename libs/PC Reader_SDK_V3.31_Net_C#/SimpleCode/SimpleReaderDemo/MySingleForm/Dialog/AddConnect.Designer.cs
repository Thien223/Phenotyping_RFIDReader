namespace SimpleReaderDemo.MySingleForm.TestForm.Dialog
{
    partial class AddConnect
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cb_usbParam = new System.Windows.Forms.ComboBox();
            this.SuspendLayout();
            // 
            // label1
            // 
            ...
            resources.GetString("cb_ConnectType.Items3")});
            ...
            // cb_usbParam
            // 
            this.cb_usbParam.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            this.cb_usbParam.FormattingEnabled = true;
            this.cb_usbParam.Items.AddRange(new object[] {
            resources.GetString("cb_usbParam.Items"),
            resources.GetString("cb_usbParam.Items1"),
            resources.GetString("cb_usbParam.Items2"),
            resources.GetString("cb_usbParam.Items3"),
            resources.GetString("cb_usbParam.Items4")});
            resources.ApplyResources(this.cb_usbParam, "cb_usbParam");
            this.cb_usbParam.Name = "cb_usbParam";
            this.cb_usbParam.DropDown += new System.EventHandler(this.cb_usbParam_DropDown);
            // 
            // AddConnect
            // 
            ...
            this.Controls.Add(this.cb_usbParam);
            this.IsResize = false;
        ...
        private System.Windows.Forms.ComboBox cb_usbParam;
    }
}